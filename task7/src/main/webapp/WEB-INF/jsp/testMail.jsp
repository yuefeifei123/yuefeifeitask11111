...
<form action="${pageContext.request.contextPath}/login/test/mailing" method="post">
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="loginMail" value="${login.loginMail}"></td>
                                </tr>
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">邮箱验证码:</td>

                                    <td><input type="text" name="loginMailCode" value="${loginMailCode}"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <input style="background-color: #ff5050;"
                                           type="button" value="修改" onclick="submit()">
                                </tr>
                            </table>
                        </form>
</div>
<div style="text-align:center">
    <%--验证码表单--%>
    <form action="${pageContext.request.contextPath}/login/test/mail" method="post">
        <table>
            <tr>
                <td style="color: #ff5c00;font-size: 20px;">邮箱号:</td>
                <td><input type="text" name="loginMail" value="${login.loginMail}"></td>
            </tr>
            <tr>
