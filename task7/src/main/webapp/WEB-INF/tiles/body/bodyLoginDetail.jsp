                    ...
                    <div class="main-rb">
                        <form  method="post">
                            <table>
                                ...
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">绑定的手机号:</td>

                                    <td>${login.loginMobile}</td>
                                </tr>
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">绑定的邮箱号:</td>

                                    <td>${login.loginMail}</td>
                                </tr>
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">头像:</td>

                                    <td><img src="${login.loginPicture}"></td>
                                </tr>
                                <tr>
