                ...
                <div class="mr-in">
                    ...
                    <div class="main-rb">
                        <form  method="post">
                            <table>
                                <tr>
                                    ...
                                    <td><input type="hidden" name="loginAccount" value="${login.loginAccount}"></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">头像:
                                    <img src="${login.loginPicture}" ></td>

                                    <td><input type="hidden" name="loginPicture" value="${online}"></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="text-align: center;color: #FFFFFF">
                                        <button style="background-color: #ff5050;"
                        ...
                        <form action="${pageContext.request.contextPath}/login/test/img" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="loginAccount" value="${login.loginAccount}">
                            <input type="hidden" name="loginPassword" value="${login.loginPassword}">
                            <input type="hidden" name="loginName" value="${login.loginName}">
                            <%--<input type="hidden" name="loginPicture" value="${login.loginAccount}">--%>
                            <input style="background-color: #ff5050;"
                                   type="button" value="上传" onclick="submit()">
                            <div style="text-align:center">
                                <p>头像预览</p><img  src="${online}"/>
                            </div>
                        </form>
                    </div>
                </div>
